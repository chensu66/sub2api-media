  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <div v-if="createForm.platform !== 'media'" class="border-t border-gray-200 pt-4 mt-4 dark:border-dark-400">
    ...
    >
      ...
      >
        ...
        <div v-if="editForm.platform !== 'media'" class="border-t border-gray-200 pt-4 mt-4 dark:border-dark-400">
          <div class="flex items-start justify-between gap-4">
            <div>
              <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.title") }}</h4>
              <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ t("admin.groups.modelPricing.description") }}</p>
...
const handleUpdateGroup = async () => {
  ...
  try {
    ...
    const payload = {
      ...editForm,
      long_context_pricing_enabled:
        editForm.platform !== "media" && editForm.long_context_pricing_enabled,
      model_pricing:
        editForm.platform === "media"
          ? []
